...
export default {
  ui: {
    ...
    intro: {
      ...
      lead: 'You will walk the path from student to minister. Temptations at every step. You have 1 minute. Your choices don\'t change numbers — they change who you become.',
      ctaStart: 'Start the journey',
      ctaSubtitle: 'No registration. One game — 15 minutes.',
      legendKicker: 'How to read stats',
      timerKicker: 'Timer',
      timerCopy: '60 seconds. If you don\'t decide — they will decide for you. That is also an answer.',
    },
    stats: {
      integrity: 'Integrity',
