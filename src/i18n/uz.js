...
export default {
  ui: {
    ...
    intro: {
      ...
      headline_post: '?',
      lead: 'Sen talabadan vazirga qadar yo\'l bosasan. Har qadamda — vasvasalar. Tanlovlaring raqamlarni emas — kim bo\'lishingni o\'zgartiradi.',
      heroMotivation: 'Men har doim tizimda ishlashni va uni o\'zgartirishni xohlardim. Menga hammasi odamlardan bog\'liqdek tuyulardi. Bugun birinchi marta tushundim — tizim seni tezroq o\'zgartiradi.',
      ...
      timerKicker: 'Taymer',
      timerCopy: 'Har sahnada vaqt cheklangan. Agar qaror qilmasang — sening o\'rningga hal qilishadi. Bu ham javob.',
    },
    stats: {
      integrity: 'Halollik',
    ...
    preEnding: {
      defaultName: 'Do\'stim',
      reveal: 'Yakunni ko\'rish',
      honor: {
        line1: '{name}, seni sahnaga taklif qilmoqdalar.',
        line2: 'Yo\'l og\'ir edi. Lekin sen yurding.',
        line3: 'Oyna oldida turibsan. Va u yerda tanish odam.',
      },
      danger: {
        line1: '{name}, seni chaqirishmoqda. Ogohlantirishsiz.',
        line2: 'Sen juda ko\'p xavf qilding. Tizim sabrsiz.',
        line3: 'Eshik ortida kim turganini bilmaysan.',
      },
      corrupt: {
        line1: '{name}, narsalar yaxshi ketmoqda. Juda yaxshi.',
        line2: 'Pul bor. Aloqalar bor. Lekin telefon jiringladi.',
        line3: 'Raqam — notanish. Ovoz — rasmiy.',
      },
      gray: {
        line1: '{name}, sen yolg\'iz o\'tiribsan.',
        line2: 'Hech kim qo\'ng\'iroq qilmayapti. Hech kim kutmayapti.',
        line3: 'Sen bu yo\'lni o\'zing tanlading. Yoki tanlating.',
      },
      tags: {
        briber: 'Tizim seni eslaydi: «murosaga moyil»',
        whistleblower: 'Tizim seni eslaydi: «xabar beruvchi»',
        silent: 'Tizim seni eslaydi: «jimjit»',
        principled: 'Tizim seni eslaydi: «printsipial»',
        neutral: '',
      },
    },
  },
