...
export default {
  ui: {
    ...
    teacher: {
      cabinet: 'O\'qituvchi kabineti',
      logout: 'Chiqish',
      scenarios: 'Ssenariylar',
      published: 'Nashr etilgan',
      sessions: 'Sessiyalar',
      active: 'Faol',
      noScenarios: 'Hali ssenariylar yo\'q',
      createFirst: '+ Birinchisini yaratish',
      newScenario: '+ Yangi',
      scenarioTitle: 'Yangi ssenariy',
      scenarioNamePlaceholder: 'Ssenariy nomi...',
      cancel: 'Bekor qilish',
      create: 'Yaratish',
      edit: 'Tahrirlash',
      unpublish: 'Bekor qilish',
      publish: 'Nashr etish',
      ...
      activeStatus: 'Faol',
      finishedStatus: 'Tugagan',
      players: 'o\'yinchi',
      manage: 'Boshqarish',
      back: '← Orqaga',
      sessionCode: 'Kirish kodi',
      start: 'Boshlash',
      finish: 'Yakunlash',
      waitingPlayers: 'O\'yinchilar kutilmoqda...',
      joinCode: 'Kirish kodi:',
      results: 'Natijalar',
      scenarioName: 'Ssenariy',
      status: 'Holat',
      playerCount: 'O\'yinchilar',
      finished: 'Tugatdi',
      inGame: 'O\'yinda...',
